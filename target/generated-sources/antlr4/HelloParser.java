...
public class HelloParser extends Parser {
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				{
				setState(61); ifStatement();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(62); loopStatement();
				}
				break;
			case 5:
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(71); ((FunctCallLabelContext)_localctx).funName = match(IDENT);
			setState(72); match(LPARE);
			setState(74);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << BOOLEAN) | (1L << INTEGER) | (1L << IDENT))) != 0)) {
				{
				setState(73); ((FunctCallLabelContext)_localctx).callParam = callParameters();
				}
			}

			setState(76); match(RPARE);
	...
	public final CallParametersContext callParameters() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(79); ((CallParamLabelContext)_localctx).first = expression(0);
			setState(84);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__0) {
	...
	public final ParametersContext parameters() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(87); ((PassParametersContext)_localctx).first = parameter();
			setState(92);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__0) {
	...
	public final ParameterContext parameter() throws RecognitionException {
		...
		try {
			...
			setState(98); type();
			setState(99); ((ParameterLabelContext)_localctx).name = match(IDENT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			if (_la==T__11) {
				{
				setState(102); ((FunctDefLabelContext)_localctx).ret = type();
				}
			}

			setState(105); ((FunctDefLabelContext)_localctx).name = match(IDENT);
			setState(106); match(LPARE);
			setState(108);
			_la = _input.LA(1);
			if (_la==T__18 || _la==T__11) {
				{
				setState(107); ((FunctDefLabelContext)_localctx).parm = parameters();
				}
			}

			setState(110); match(RPARE);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__18) | (1L << T__17) | (1L << T__16) | (1L << T__14) | (1L << T__9) | (1L << T__7) | (1L << IDENT))) != 0)) {
				...
				case IDENT:
					{
					setState(112); ((FunctDefLabelContext)_localctx).funcstat = statement();
					}
					break;
				case T__16:
					{
					setState(113); ((FunctDefLabelContext)_localctx).funcret = returnStatement();
					}
					break;
				default:
					throw new NoViableAltException(this);
	...
	public final VariableContext variable() throws RecognitionException {
		...
		try {
			...
			setState(129); type();
			setState(130); ((DeclarationLabelContext)_localctx).variableName = match(IDENT);
			setState(133);
			_la = _input.LA(1);
			if (_la==ASSIGNMENT) {
				{
				setState(131); match(ASSIGNMENT);
	...
	public final IfStatementContext ifStatement() throws RecognitionException {
		...
		try {
			...
			setState(140); ((IFStatementLabel1Context)_localctx).express1 = expression(0);
			...
			do {
				{
				{
				setState(142); ((IFStatementLabel1Context)_localctx).stat1 = statement();
				}
				}
				setState(145); 
				_errHandler.sync(this);
			...
			if (_la==T__5) {
				...
				do {
					{
					{
					setState(148); ((IFStatementLabel1Context)_localctx).stat2 = statement();
					}
					}
					setState(151); 
					_errHandler.sync(this);
	...
	public final LoopStatementContext loopStatement() throws RecognitionException {
		...
		try {
			...
			setState(160); ((LoopStatLabelContext)_localctx).expr = expression(0);
			setState(162);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__18) | (1L << T__17) | (1L << T__14) | (1L << T__9) | (1L << T__7) | (1L << IDENT))) != 0)) {
				{
				setState(161); ((LoopStatLabelContext)_localctx).stat = statement();
				}
			}

			setState(164); ((LoopStatLabelContext)_localctx).end = match(T__15);
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << BOOLEAN) | (1L << INTEGER) | (1L << IDENT))) != 0)) {
				{
				setState(168); ((ReturnLabelContext)_localctx).value = expression(0);
				}
			}
	...
	public final AssignmentContext assignment() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(178); ((AssignmentLabelContext)_localctx).var = match(IDENT);
			setState(179); match(ASSIGNMENT);
			setState(180); ((AssignmentLabelContext)_localctx).expr = expression(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(191); ((DivLabelContext)_localctx).op = match(DIV);
						setState(192); ((DivLabelContext)_localctx).rightexpr = expression(12);
						}
						break;
					case 2:
						{
						...
						setState(194); ((MultLabelContext)_localctx).op = match(MULT);
						setState(195); ((MultLabelContext)_localctx).rightexpr = expression(11);
						}
						break;
					case 3:
						{
						...
						setState(197); ((SubtLabelContext)_localctx).op = match(SUBT);
						setState(198); ((SubtLabelContext)_localctx).rightexpr = expression(10);
						}
						break;
					case 4:
						{
						...
						setState(200); ((AddLabelContext)_localctx).op = match(ADD);
						setState(201); ((AddLabelContext)_localctx).rightexpr = expression(9);
						}
						break;
					case 5:
						{
						...
						consume();
						setState(204); ((GTLTEQLabelContext)_localctx).rightexpr = expression(8);
						}
						break;
					case 6:
						{
						...
						consume();
						setState(207); ((GTEQLTEQLabelContext)_localctx).rightexpr = expression(7);
						}
						break;
					case 7:
						{
						...
						consume();
						setState(210); ((AndORNotLabelContext)_localctx).rightexpr = expression(6);
						}
						break;
					}
					} 
	...
	public static final String _serializedATN =
		...
		"\62\5\4\3\2\62\63\7\2\2\3\63\3\3\2\2\2\648\7\b\2\2\65\67\5\6\4\2\66\65"+
		"\3\2\2\2\67:\3\2\2\28\66\3\2\2\289\3\2\2\29;\3\2\2\2:8\3\2\2\2;<\7\13"+
		"\2\2<\5\3\2\2\2=D\5\"\22\2>D\5\b\5\2?D\5\32\16\2@D\5\34\17\2AD\5\n\6\2"+
		"BD\5 \21\2C=\3\2\2\2C>\3\2\2\2C?\3\2\2\2C@\3\2\2\2CA\3\2\2\2CB\3\2\2\2"+
		...
		"\t\2\2P\13\3\2\2\2QV\5$\23\2RS\7\25\2\2SU\5$\23\2TR\3\2\2\2UX\3\2\2\2"+
		"VT\3\2\2\2VW\3\2\2\2W\r\3\2\2\2XV\3\2\2\2Y^\5\20\t\2Z[\7\25\2\2[]\5\20"+
		"\t\2\\Z\3\2\2\2]`\3\2\2\2^\\\3\2\2\2^_\3\2\2\2_\17\3\2\2\2`^\3\2\2\2a"+
		"c\7\3\2\2ba\3\2\2\2bc\3\2\2\2cd\3\2\2\2de\5\30\r\2ef\7\31\2\2f\21\3\2"+
		"\2\2gi\7\22\2\2hj\5\30\r\2ih\3\2\2\2ij\3\2\2\2jk\3\2\2\2kl\7\31\2\2ln"+
		"\7*\2\2mo\5\16\b\2nm\3\2\2\2no\3\2\2\2op\3\2\2\2pq\7+\2\2qv\7\b\2\2ru"+
		"\5\6\4\2su\5\36\20\2tr\3\2\2\2ts\3\2\2\2ux\3\2\2\2vt\3\2\2\2vw\3\2\2\2"+
		"wy\3\2\2\2xv\3\2\2\2yz\7\13\2\2z\23\3\2\2\2{|\7\4\2\2|}\5\30\r\2}~\7\31"+
		"\2\2~\177\7)\2\2\177\u0080\5$\23\2\u0080\u0081\7\t\2\2\u0081\25\3\2\2"+
		"\2\u0082\u0083\7\3\2\2\u0083\u0084\5\30\r\2\u0084\u0087\7\31\2\2\u0085"+
		"\u0086\7)\2\2\u0086\u0088\5$\23\2\u0087\u0085\3\2\2\2\u0087\u0088\3\2"+
		"\2\2\u0088\u0089\3\2\2\2\u0089\u008a\7\t\2\2\u008a\27\3\2\2\2\u008b\u008c"+
		"\7\n\2\2\u008c\31\3\2\2\2\u008d\u008e\7\f\2\2\u008e\u008f\5$\23\2\u008f"+
		"\u0091\7\24\2\2\u0090\u0092\5\6\4\2\u0091\u0090\3\2\2\2\u0092\u0093\3"+
